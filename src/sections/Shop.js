...
const Shop = () => {
  ...
  return (
    <Section ref={ref} id="collection">
      ...
      <Left>
        <p>
          Freestyle Working BV is a right partner for your follow up orders, our
          ability to leverage vertical and horizontal integration. Freestyle
          Working BV is the Best solution for take care your orders around the
          world
        </p>
      </Left>
